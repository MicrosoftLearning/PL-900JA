---
lab:
    title: 'ラボ 03: キャンバス アプリ、パート2'
    module: 'モジュール 03: Common Data Service の概要'
---

# PL-900 : Microsoft-Power-Platform-Fundamentals
## モジュール 3、ラボ 3 – キャンバス アプリ、パート 2
...
2.  新しいキャンバス アプリケーションを作成する
    ...
    -   「**新規**」 をクリックし、「**App \| キャンバス アプリ \| 携帯電話フォーム ファクター**」 を選択する。
...
3.  データ ソースへの接続 (訪問)
    ...
    3.  「**訪問**」 を選択する
4.  進行中の作業を保持するには、をクリックする **ファイル | 保存**、次に **保存** を押下する
...
3.  進行中の作業を保持するには、をクリックする **ファイル | 保存**、次に **保存** を押下する
...
5. 進行中の作業を保持するには、をクリックする **ファイル | 保存**、次に **保存** を押下する。  
...
2. 「**アイコン | 追加**」 を選択します。この時点では、値を動的にするので、どのアイコンを選択しても構いません。
