---
lab:
    title: 'ラボ 06: Power BI'
    module: 'モジュール 05: Power BI を開始'
---

# PL-900 : Microsoft-Power-Platform-Fundamentals
## モジュール 4、ラボ 6 – Power BI
...
-   利用者はどのようにレポートを活用しますか? 典型的なデバイスを使っていますか? 場所は?
-   視覚化するのに十分なデータがありますか?
...
17. **「ファイル | 保存」** を押して進行中の作業を保存しますして、選択したファイル名を入力します。
...
11. **「ファイル | 保存」** を押して進行中の作業を保存しますします。
